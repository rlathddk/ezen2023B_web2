...
public class MemberService implements UserDetailsService, OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public UserDetails loadUserByUsername(String memail) throws UsernameNotFoundException {
        ...
        if(memberEntity == null){return null;} // userDetails가 null이면 패스워드 검증 실패 했기 때문에

        // - ROLE 부여
            // GrantedAuthority : 권한의 의미를 저장 클래스
...
//        return null;
        ...
        // 3. 로그인 상태이명 UserDetails 타입 변환
        UserDetails userDetails = (UserDetails)object;
        // 4. 로그인 성공한 엔티티 찾기
        MemberEntity m =
                memberEntityRepository.findByMemail(userDetails.getUsername());
